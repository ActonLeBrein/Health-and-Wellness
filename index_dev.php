		...
		<div id="content">
			...
			<form id="formulario" name="formulario" action="index.php#calificacion" method="get">
				...
				<div id="preguntas">
					...
					<div id="tittle">¿Cual es tu número de salud?</div>
					...
					<div id="pregunta2" style="display:none" class="pregunta mujer">
						...
						<div class="respuesta5" onclick="mostrar('pregunta3');">Siguiente</div>
					</div>
					...
					<div id="pregunta3" style="display:none" class="pregunta">
						...
						<div class="respuesta5" onclick="mostrar('pregunta4');">Siguiente</div>													
					</div>

					<div id="pregunta4" style="display:none" class="pregunta" data-next="pregunta5">
						<h3>Entre comidas, ¿Comes comida chatarra o alimentos no saludables?</h3>
					...
					<div id="pregunta5" style="display:none" class="pregunta" data-next="pregunta6">
						...
						<p class="example">(por ejemplo, evitas comerte la grasa de la carne, evitas comer tocineta, etc.)</p>
					...
					<div id="pregunta7" style="display:none" class="pregunta">
						...
						<div class="respuesta5" onclick="mostrar('pregunta8');">Siguiente</div>
					</div>
					...
					<div id="pregunta8" style="display:none" class="pregunta">
						...
						<div class="respuesta5" onclick="mostrar('pregunta9');">Siguiente</div>		
					</div>
					...
					<div id="pregunta22" style="display:none" class="pregunta">
						...
						<div class="respuesta5" onclick="mostrar('pregunta23');">Siguiente</div>
					...
					<div id="pregunta23" style="display:none" class="pregunta">
						...
						<div class="respuesta5" onclick="mostrar('pregunta24');">Siguiente</div>
					...
					<div id="pregunta24" style="display:none" class="pregunta">
						...
						<div class="respuesta5" onclick="mostrar('pregunta10a');">Siguiente</div>
					...
					<div id="pregunta10a" style="display:none" class="pregunta">
						...
						<p class="example">Metros <input type="radio" name="altura" value="metros" checked>Pies.Pulgadas <input type="radio" name="altura" value="pies_pulgadas"></p>
						<div class="regresar" onclick="mostrar('pregunta24');">
							Regresar
							<div class="trazo"></div>
						</div>
						<input class="input_answer decimal" type="text" name="pregunta10a">
						<div class="respuesta5" onclick="mostrar('pregunta10b');">Siguiente</div>
					</div>

					<div id="pregunta10b" style="display:none" class="pregunta">
						<h3>¿Cuál es tu peso?</h3>
						<p class="example">Kilogramos <input type="radio" name="peso" value="kilo" checked>Libras <input type="radio" name="peso" value="libra"></p>
						<div class="regresar" onclick="mostrar('pregunta10a');">
							Regresar
							<div class="trazo"></div>
						</div>
						<input class="input_answer numerico" type="text" name="pregunta10b">
						<div class="respuesta5" onclick="mostrar('pregunta11');">Siguiente</div>
					</div>
					...
					<div id="pregunta16" style="display:none" class="pregunta">
						...
						<div class="respuesta5" onclick="mostrar('pregunta17');">Siguiente</div>
					...
					<div id="pregunta17" style="display:none" class="pregunta">
						...
						<div class="respuesta5" onclick="mostrar('pregunta18');">Siguiente</div>
					...
					<div id="pregunta18" style="display:none" class="pregunta">
						...
						<div class="respuesta5" onclick="mostrar('pregunta19');">Siguiente</div>
					...
					<div id="pregunta19" style="display:none" class="pregunta" data-next="pregunta20">
						<h3>¿Cuál ha sido tu acercamiento al tabaco?</h3>
						<div class="regresar" onclick="mostrar('pregunta18');">
							Regresar
							<div class="trazo"></div>
						</div>
						<div class="respuesta respuesta1 multi1" data-respuesta="1">Nunca fumaste o dejaste de fumar hace más de 2 años</div>
						<div class="respuesta respuesta2 multi1 lr1" data-respuesta="2">Dejaste de fumar hace menos de 2 años</div>
						<div class="respuesta respuesta3 multi2 lr2" data-respuesta="3">Fumas pipa o puro, o eres fumador pasivo</div>								
						<div class="respuesta respuesta4 multi2 lr3" data-respuesta="4">Fumas cigarrillo</div>													
					...
					<div id="pregunta20" style="display:none" class="pregunta">
						...
						<div class="respuesta5" onclick="mostrar('pregunta21');">Siguiente</div>
				...
				<div class="valores">
					...
					<div id="r_mejora" class="resp" style="display:none">	                    
	                    ...
	                    <script>
	    						var href = 'https://www.facebook.com/dialog/feed?app_id=121515388058397&name=Este%20es%20el%20resultado%20de%20mi%20quiz%20de%20salud.%20Toma%20el%20tuyo%20aquí%20y%20entérate%20qué%20tan%20saludable%20eres.&picture=http://univision.data4.mx/ws/images/salud.png&display=popup&caption=¿Cuál%20es%20tu%20número%3f&&link='+escape('<?php echo $href; ?>')+'&redirect_uri='+escape('<?php echo $href; ?>');						
						...
						<div class="tips">
							<div id="tip_pregunta3" class="tip <?php if (in_array($_GET["pregunta3"], array(1,2))) {echo 'sprite-ejercicio_active tip_activo'; }else{ echo 'sprite-ejercicio_inactive';} ?>"></div>
							...
							<div id="tip_pregunta7" class="tip <?php if ($_GET["pregunta7"]==2) {echo 'sprite-frutas-verduras_active tip_activo'; }else{ echo 'sprite-frutas-verduras_inactive';}?>"></div>
							<div id="tip_pregunta8" class="tip <?php if ($_GET["pregunta8"]==2) {echo 'sprite-agua_active tip_activo'; }else{ echo 'sprite-agua_inactive';}?>"></div>
							...
							<div id="tip_pregunta10" class="tip <?php if (in_array($_GET["pregunta10"], array(1,3,4))) {echo 'sprite-imc_active tip_activo'; }else{ echo 'sprite-imc_inactive';} ?>" ></div>
							...
							<div id="tip_pregunta16" class="tip <?php if (in_array($_GET["pregunta16"], array(3,4))) {echo 'sprite-alcohol_active tip_activo'; }else{ echo 'sprite-alcohol_inactive';} ?>"></div>
							<div id="tip_pregunta17" class="tip <?php if ($_GET["pregunta17"]==2) {echo 'sprite-dormir_active tip_activo'; }else{ echo 'sprite-dormir_inactive';}?>"></div>
							<div id="tip_pregunta18" class="tip <?php if ($_GET["pregunta18"]==2) {echo 'sprite-enfermo_active tip_activo'; }else{ echo 'sprite-enfermo_inactive';}?>"></div>
							...
							<div id="tip_pregunta20" class="tip <?php if ($_GET["pregunta20"]==2) {echo 'sprite-desayuno_active tip_activo'; }else{ echo 'sprite-desayuno_inactive';} ?>"></div>
					...
					<?php  
						...
						/*if (!mysql_query("insert into ws values (id,'".$_GET["facebook_id"]."','".$_GET["location"]."',".$_GET["pregunta0"].",".$_GET["pregunta1"].",".$_GET["pregunta2"]."
							,".$_GET["pregunta3"].",".$_GET["pregunta4"].",".$_GET["pregunta5"].",".$_GET["pregunta6"].",".$_GET["pregunta7"].",".$_GET["pregunta8"]."
							,".$_GET["pregunta9"].",".$_GET["pregunta10"].",".$_GET["pregunta11"].",".$_GET["pregunta12"].",".$_GET["pregunta13"].",".$_GET["pregunta14"]."
